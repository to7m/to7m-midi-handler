...
TimestampedLcp0ToCorePslotMsg = new_msg_type(
    ToRecordingsManagerMsg, 6, "TimestampedLcp0ToCorePslotMsg",
    ["timestamp_ns", "nested"]
)
...
TimestampedLcpToCoreRecordingsManagerMsg = new_msg_type(
    ToRecordingsManagerMsg, 7, "TimestampedLcpToCoreRecordingsManagerMsg",
    ["timestamp_ns", "nested"]
)
...
UpdateRecordingsMsg = new_msg_type(
    ToRecordingsManagerMsg, 8, "RecordingsUpdatedMsg"
)
